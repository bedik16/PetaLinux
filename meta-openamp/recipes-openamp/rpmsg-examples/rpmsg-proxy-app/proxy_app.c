...
static pthread_t ui_thread, compute_thread, http_thread;
...
void *ui_thread_entry(void *ptr)
{
	...
	while (flag) {
		...
		printf(" Please enter command and press enter key\r\n");
                ...
                printf(" WORKING WORKING WORKING WORKING \r\n");
		printf(" **************************************** \r\n");
...
void *http_thread_entry(void *ptr)
{
        startHttpServer();
	return 0;
}
...
int main(int argc, char *argv[])
{
	...
	printf("\r\n Creating ui_thread and compute_thread and http_thread ... \r\n");

	pthread_create(&http_thread, NULL, &http_thread_entry, "http_thread");
